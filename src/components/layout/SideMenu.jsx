    ...
    <div className={`${isMobile ? 'w-full' : 'w-52 xl:w-64'} h-screen bg-[#EDF6F9] flex flex-col`}>
      ...
      <div className="pt-3 border-b border-[#d3d1d1] flex items-center justify-between">
        <div className="flex items-center justify-center space-x-3 flex-1">
          <img src="/op_logo.png" alt="Optel Logo" className="w-[9rem] aspect-1" />
        </div>
        {isMobile && (
          <button
            onClick={onClose}
            ...
            {profileMenuOpen && (
              <div className="absolute right-0 bottom-full mb-2 w-48 bg-white border border-[#d3d1d1] rounded-lg shadow-lg z-50 py-2">
                <button
                  ...
                  className="w-full text-left px-4 py-2 text-base text-gray-700 hover:bg-gray-50 flex items-center gap-2"
                >
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-2 text-base text-red-600 hover:bg-red-50 flex items-center gap-2"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
